      ...
      >
        {isSuccess ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-2xl font-bold text-tm-white mb-2">
              Message Sent!
            </h3>
            <p className="text-tm-slate">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
              <label
                htmlFor="name"
                className="block text-sm font-medium text-tm-slate-light mb-2"
              >
                Name
              </label>
              <input
                ...
                type="text"
                className={`w-full bg-tm-navy-light border ${
                  errors.name ? 'border-red-500' : 'border-tm-navy-lighter'
                } rounded px-4 py-3 text-tm-white focus:outline-none focus:border-tm-green transition-colors`}
            ...
            <div>
              ...
              <input
                ...
                type="email"
                className={`w-full bg-tm-navy-light border ${
                  errors.email ? 'border-red-500' : 'border-tm-navy-lighter'
                } rounded px-4 py-3 text-tm-white focus:outline-none focus:border-tm-green transition-colors`}
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className={`w-full bg-tm-navy-light border ${
                  errors.message ? 'border-red-500' : 'border-tm-navy-lighter'
                } rounded px-4 py-3 text-tm-white focus:outline-none focus:border-tm-green transition-colors resize-none`}
