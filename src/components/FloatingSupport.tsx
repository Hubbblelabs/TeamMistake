    ...
    return (
        <>
            ...
            <a
                ...
                className="fixed bottom-6 left-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300"
            ...
            <Link
                ...
                aria-label="Need Support? Visit Support Center"
            >
                {/* Tooltip */}
                <span
                ...
                <div className="w-14 h-14 bg-gradient-to-br from-tm-green to-emerald-600 rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 flex items-center justify-center">
                    <svg
                        ...
                        className="w-6 h-6 text-tm-navy"
                    >
