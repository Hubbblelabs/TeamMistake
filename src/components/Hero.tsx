    ...
    return (
        <section className="min-h-screen flex items-center justify-center pt-20 px-6 relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto text-center">
                ...
                >
                    We Deliver What You <span className="text-tm-green">NEED</span>, <br className="hidden md:block" />
                ...
                >
                    At our core, we are a client-centric software company, driven by innovation and dedicated to crafting solutions that align with your unique needs. We transform challenges into opportunities through cutting-edge technology and personalized service.
                </motion.p>
